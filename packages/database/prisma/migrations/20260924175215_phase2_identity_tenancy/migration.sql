-- CreateEnum
CREATE TYPE "MembershipRole" AS ENUM ('OWNER', 'ADMIN', 'CONTENT_MANAGER', 'EDITOR', 'REVIEWER', 'ANALYST', 'VIEWER');

-- CreateEnum
CREATE TYPE "ClientStatus" AS ENUM ('ACTIVE', 'PAUSED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "ApprovalMode" AS ENUM ('REQUIRED', 'OPTIONAL', 'AUTO');
...
CREATE TABLE "Client" (
    ...
    "driveFolderId" TEXT,
    "approvalMode" "ApprovalMode" NOT NULL DEFAULT 'REQUIRED',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
